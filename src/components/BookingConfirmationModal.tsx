...
export const BookingConfirmationModal: React.FC<BookingConfirmationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-md flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
      <div className="bg-[#F8F5F0] border border-[#1B3B36]/20 rounded-2xl sm:rounded-3xl max-w-md w-full p-4 sm:p-6 shadow-2xl relative my-auto max-h-[92vh] flex flex-col font-sans overflow-hidden">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto space-y-3.5 sm:space-y-4 pr-1 scrollbar-none">
          {/* Top Voucher Banner */}
          <div className="text-center space-y-1.5 pt-1 sm:pt-2">
            ...
            <h2 className="text-lg sm:text-xl font-serif font-bold text-[#1B3B36]">
          ...
          {/* Voucher Ticket Box */}
          <div className="bg-[#EAE3D8] border border-[#1B3B36]/15 rounded-2xl p-3.5 sm:p-4 space-y-3 shadow-sm">
            <div className="flex items-center justify-between pb-2 border-b border-[#1B3B36]/10">
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <button
                    ...
                    className="p-2 rounded bg-[#F8F5F0] hover:bg-[#1B3B36] hover:text-white text-[#1B3B36] transition-colors min-w-[40px] min-h-[40px] flex items-center justify-center cursor-pointer active:scale-95"
                    title="Copiar Código"
                  >
              ...
              <div className="w-10 h-10 bg-white rounded-lg p-1 flex items-center justify-center border border-[#1B3B36]/10 shrink-0">
            ...
            <div className="space-y-1.5 text-xs">
              <div className="flex justify-between">
                ...
                <span className="font-bold text-[#1B3B36] truncate ml-2">{booking.guestName}</span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="p-3 bg-white rounded-xl border border-[#1B3B36]/15 flex items-center justify-between text-xs font-sans gap-2">
            <div className="flex items-center gap-2 text-[#1B3B36]/80 min-w-0">
            ...
            <a
              ...
              className="text-[#1B3B36] hover:text-emerald-800 underline flex items-center gap-1 font-semibold text-[11px] shrink-0"
            >
          ...
          <div className="space-y-2 font-sans pt-1">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full bg-[#1B3B36] hover:bg-emerald-900 text-white font-bold py-3 px-4 rounded-xl text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-md transition-all min-h-[48px] active:scale-95"
            >
            ...
            <button
              onClick={onClose}
              className="w-full bg-[#EAE3D8] hover:bg-[#1B3B36]/10 text-[#1B3B36] py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-colors min-h-[44px] cursor-pointer"
            >
              Cerrar y Volver
            </button>
          </div>
